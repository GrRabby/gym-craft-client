...
import { getAllForumPosts } from "@/actions/forum-posts";
import ManageForumPostsTable from "@/app/components/ManageForumPostsTable";
...
export default async function AdminForumManagePage() {
    ...
    const { posts, error } = await getAllForumPosts();
    ...
    return (
        <div className="flex-1 flex flex-col">
                ...
                <div className="flex items-end justify-between flex-wrap gap-3">
                    <div>
                        ...
                        <p className="text-[#cfc6b8] text-sm mt-2">
                            Moderate community posts. Delete any post that violates platform guidelines.
                        </p>
                    </div>
                    {posts.length > 0 && (
            ...
            {error ? (
                ...
                <ManageForumPostsTable initialPosts={posts} />
            )}
        </div>
    );
}