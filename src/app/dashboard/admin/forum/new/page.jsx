...
export default async function AdminAddForumPostPage() {
        ...
        <div className="flex-1 flex flex-col">
            <div className="mb-8">
                ...
                <p className="text-[#cfc6b8] text-sm mt-2">
                    Publish announcements, updates, or guidance for the community.
                </p>
            </div>
            <AddForumPostForm redirectOnSuccess="/dashboard/admin" />
        </div>
    );
}